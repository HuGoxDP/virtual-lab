...
> [`../../../.claude-shared/PLAN.md`](../../../.claude-shared/PLAN.md)**, which picks up the items these phases deliberately left open.
...
**Still open — tracked as R3 in [`../../../.claude-shared/PLAN.md`](../../../.claude-shared/PLAN.md), and half-solved by the engine.** `release:local` stamps a unique version into
...
cannot start on the platform side. Tracked as **R8** in [`../../../.claude-shared/PLAN.md`](../../../.claude-shared/PLAN.md).
